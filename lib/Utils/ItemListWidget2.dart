...
class ItemListWidget2 extends StatefulWidget {
  ...
  ItemListWidget2(this.itemModel);

  @override
  _ItemListWidget2 createState() => _ItemListWidget2(itemModel);
}

class _ItemListWidget2 extends State<ItemListWidget2> {
  ItemModel item;

  _ItemListWidget2(this.item);
