...
class ManageBrandScreen extends StatefulWidget{
  @override
  _ManageBrandScreen createState() => _ManageBrandScreen();

}

class _ManageBrandScreen extends State<ManageBrandScreen>{
  var utils = AppUtils();
                            ...
                            return Wrap(
                              ...
                              children: [
                                for(var i = 0; i < lengthBrands; i++)
                                  GestureDetector(
                                    onTap: (){
                                      //Get.toNamed(manageSubCategoryRoute, arguments: categoryController.categories[i]);
                                    },
                                    child: Container(
                                      width: Get.width * 0.4,
                                      height: 160,
                                            ...
                                            child: Stack(
                                              children: [
                                                Container(
                                                  ...
                                                  child: Image.network(brandController.filterBrands[i].image != null ? brandController.filterBrands[i].image! :"https://s7d2.scene7.com/is/image/Caterpillar/CM20200212-04866-33d60", fit: BoxFit.cover,),
                                                ),
                                                GestureDetector(
                                                  onTap: (){
