...
class _AddProductNewScreen extends State<AddProductNewScreen> {
  ...
  var activeStep = 0;
  var utils = AppUtils();
  ItemModel addProductModel = Get.arguments ??
      ItemModel(
          status: 0,
          code: "",
          name: "",
  ...
  */
  ...
  void initState() {
    ...
    if (addProductModel.code != "") {
      ...
      selectedCategoryItem = CategoryModel(
          code: addProductModel.type,
          image: "",
          name: addProductModel.typeName ?? "",
          secondName: addProductModel.typeName,
          isEnable: true);
      selectedSubCategoryItem = SubCategoryModel(
          type: addProductModel.type,
          code: addProductModel.style,
          image: "",
          name: addProductModel.styleName ?? "",
          secondName: addProductModel.styleName,
          isEnable: true);
      ...
      selectedBrand = BrandModel(
          code: addProductModel.brandCode ?? "",
          name: addProductModel.brandName ?? "Select Brand",
          image: "",
          secondName: addProductModel.brandName ?? "Select Brand",
          isEnable: true);
      sDescriptionController.text = addProductModel.shortDescription ?? "";
      descriptionController.text = addProductModel.description ?? "";
      pDeliveryPriceController.text = addProductModel.deliveryPrice != 0
          ? addProductModel.deliveryPrice.toString()
          : "";
      pDeliveryApplyController.text = addProductModel.deliveryApplyItem != 0
          ? addProductModel.deliveryApplyItem.toString()
          : "";
      pDeliveryFreeController.text = addProductModel.freeDeliveryItems != -1
          ? addProductModel.freeDeliveryItems.toString()
          : "";
      pMaxDeliveryController.text = addProductModel.maxDeliveryTime != 0
          ? addProductModel.maxDeliveryTime.toString()
          : "";
      pMinDeliveryController.text = addProductModel.minDeliveryTime != 0
          ? addProductModel.minDeliveryTime.toString()
          : "";
      specs = addProductModel.specs;
      pColors = addProductModel.colors;
      addons = __itemController.getAddonsById(addProductModel.addons);
                                    ...
                                    child: Column(
                                      ...
                                      children: [
                                        Text(
                                          "Product Information",
                                          style: utils
                                              .boldSmallLabelStyle(blackColor),
                                        ),
                                        SizedBox(
                                          height: 10,
                                        ),
                                        ...
                                        form("Price", priceController,
                                            isNumber: true),
                                        SizedBox(
                                          height: 12,
                                        ),
                                        form("Whole Sale Price",
                                        ...
                                        form("Discount", discPriceController,
                                            isNumber: true),
                                        SizedBox(
                                          height: 12,
                                        ),
                                        form("GST %", gstController,
                                            isNumber: true),
                                        SizedBox(
                                          height: 12,
                                        ),
                                        form("Stock", stockController,
                                            isNumber: true),
                                        //SizedBox(height: 12,),
                                      ...
                                      child: SingleChildScrollView(
                                        child: Column(
                                          ...
                                          children: [
                                            ...
                                            form(
                                                "Short Description of 50 characters",
                                                sDescriptionController,
                                                onChange: (val) {
                                              if (val == null) {
                                                shortDLength = 0;
                                              } else {
                                          ...
                                          child: SingleChildScrollView(
                                            child: Column(
                                              ...
                                              children: [
                                                ...
                                                Text(
                                                  "important note No delivery charges will be apply if not specified.",
                                                  style:
                                                      utils.boldSmallLabelStyle(
                                                          redColor),
                                                ),
                                                ...
                                                form("Delivery Price",
                                                    pDeliveryPriceController,
                                                    isNumber: true),
                                                SizedBox(
                                                  height: 12,
                                                ),
                                                form("Max items delivery apply",
                                                    pDeliveryApplyController,
                                                    isNumber: true),
                                                SizedBox(
                                                  height: 12,
                                                ),
                                                form(
                                                    "Number of items for free delivery",
                                                    pDeliveryFreeController,
                                                    isNumber: true),
                                                SizedBox(
                                                  height: 12,
                                                ),
                                                form(
                                                    "Min Delivery time in hours(s)",
                                                    pMinDeliveryController,
                                                    isNumber: true),
                                                SizedBox(
                                                  height: 12,
                                                ),
                                                form(
                                                    "Max Delivery time in hours(s)",
                                                    pMaxDeliveryController,
                                                    isNumber: true),
                                              ],
                                            ),
                                          ),
                                                ...
                                                children: [
                                                  ...
                                                  utils.button(
                                                      ...
                                                      checkAdminController
                                                          .system.mainColor,
                                                      1.0, () {
                                                    if (psTitleController
                                                        .text.isEmpty) {
                                                      utils.snackBar(context,
                                                          message:
                                                              "Title is required");
                                                      return;
                                                    } else if (psDescriptionController
                                                        .text.isEmpty) {
                                                      utils.snackBar(context,
                                                          message:
                                                                    ...
                                                                    children: [
                                                                      Expanded(
                                                                        child:
                                                                          ...
                                                                          selectedAddon == null
                                                                              ? "Select Addon"
                                                                              : selectedAddon!.adonDescription,
                                                                          style:
                                                                              utils.smallLabelStyle(blackColor),
                                                                        ),
                                                                      ),
                                                                      SizedBox(
                                                                        width:
                                                                ...
                                                                child: Row(
                                                                  ...
                                                                  children: [
                                                                    Expanded(
                                                                        ...
                                                                        child:
                                                                            Text(
                                                                          "${addons[i].adonDescription}",
                                                                          style:
                                                                              utils.boldSmallLabelStyle(blackColor),
                                                                        )),
                                                                    Expanded(
                                                                        flex: 1,
                                                                        child:
                                                                          ...
                                                                          "${addons[i].adonPrice}",
                                                                          style:
                                                                              utils.xSmallLabelStyle(blackColor),
                                                                        )),
                                                                    SizedBox(
                                                                      width: 6,
                                                                    ),
                                                                    ...
                                                                    Expanded(
                                                                      child:
                                                                        ...
                                                                        selectedPColor ==
                                                                                null
                                                                            ? "Select Color"
                                                                            : selectedPColor!.color,
                                                                        style: utils
                                                                            .smallLabelStyle(blackColor),
                                                                      ),
                                                                    ),
                                                                    SizedBox(
                                                                      width: 8,
                                                              ...
                                                              if (addProductModel
                                                                ...
                                                                utils.button(
                                                                  ...
                                                                  if (addProductModel
                                                                    ...
                                                                    pSizes.add(PSizes(
                                                                        size: sNameController
                                                                            .text
                                                                            .toString(),
                                                                        price: sPriceController
                                                                            .text
                                                                            .toString(),
                                                                        wPrice: sWPriceController
                                                                            .text
                                                                            .toString(),
                                                                        sizeId:
                                                                    ...
                                                                    Get.snackbar(
                                                                        "Error",
                                                                        "Edit Parent product to add more sizes");
                                                                  }
                                                                }),
                                                              SizedBox(
                                                                height: 12,
                                                              ...
                                                              Expanded(
                                                                ...
                                                                child: Wrap(
                                                                  children: [
                                                                    ...
                                                                    for (var i =
                                                                            0;
                                                                        i < addProductModel.sizes.length;
                                                                        i++)
                                                                      Container(
                                                                        width: Get
                                                                            .width,
                                                                        ...
                                                                        child:
                                                                          ...
                                                                          children: [
                                                                            Expanded(
                                                                                flex: 1,
                                                                                child: Text(
                                                                                  "${addProductModel.sizes[i].size}",
                                                                                  style: utils.boldSmallLabelStyle(blackColor),
                                                                                )),
                                                                            Expanded(
                                                                                flex: 1,
                                                                                child: Text(
                                                                                  "${addProductModel.sizes[i].price}",
                                                                                  style: utils.xSmallLabelStyle(blackColor),
                                                                                )),
                                                                            Expanded(
                                                                                flex: 1,
                                                                                child: Text(
                                                                                  "${addProductModel.sizes[i].wPrice}",
                                                                                  style: utils.xSmallLabelStyle(blackColor),
                                                                                )),
                                                                            SizedBox(
                                                                              width: 6,
                                                                            ),
                                                                            if (addProductModel.parentId ==
                                                                                null)
                                                                              InkWell(
                                                                                  onTap: () {
                                                                                    pSizes.removeAt(i);
                                                          ...
                                                          : Container(
                                                              ...
                                                              child: Column(
                                                                ...
                                                                children: [
                                                                  ...
                                                                  Text(
                                                                    "Important Note: Image should be in Maximum of 50kb size",
                                                                    style: utils
                                                                        .xSmallLabelStyle(
                                                                            redColor),
                                                                  ),
                                                                  ...
                                                                  InkWell(
                                                                    onTap: () {
                                                                      if (addProductModel.images.length +
                                                                              (GetPlatform.isWeb ? _productImagesWeb.length : _productImages.length) <
                                                                          4) {
                                                                        GetPlatform.isWeb
                                                                            ? _getImage()
                                                                            : getImage();
                                                                        ...
                                                                        Get.snackbar(
                                                                            "Error",
                                                                            "Maximum 3 Images are allowed delete old to add new One.");
                                                                      }
                                                                    },
                                                                    child: Container(
                                                                        padding: EdgeInsets.symmetric(horizontal: 30, vertical: 30),
                                                                        decoration: BoxDecoration(borderRadius: BorderRadius.circular(8), border: Border.all(color: blackColor, width: 0.5)),
                                                                        child: Center(
                                                                          child:
                                                                              Icon(
                                                                            CupertinoIcons.add,
                                                                  ...
                                                                  Expanded(
                                                                    ...
                                                                    child: Wrap(
                                                                      children: [
                                                                        for (var i =
                                                                                0;
                                                                            i < (GetPlatform.isWeb ? _productImagesWeb.length : _productImages.length);
                                                                            i++)
                                                                          Container(
                                                                              height: 200.h,
                                                                              child: Stack(
                                                                                children: [
                                                                                  Container(
                                                                                      height: 200.h,
                                                                                      margin: EdgeInsets.symmetric(horizontal: 8, vertical: 8),
                                                                                      decoration: BoxDecoration(borderRadius: BorderRadius.circular(8), color: blackColor.withOpacity(0.3), boxShadow: [
                                                                                        BoxShadow(spreadRadius: 2, blurRadius: 2, offset: Offset(0, 2), color: blackColor.withOpacity(0.2))
                                                                                      ]),
                                                                                      child: GetPlatform.isWeb
                                                                                          ? Image.memory(
                                                                                              _productImagesWeb[i].bytes!,
                                                                                              fit: BoxFit.cover,
                                                                                            )
                                                                                          : Image.file(
                                                                                              _productImages[i],
                                                                        ...
                                                                        for (var i =
                                                                                0;
                                                                            i < addProductModel.images.length;
                                                                            i++)
                                                                          Container(
                                                                              height: 200.h,
                                                                              child: Stack(
                                  ...
                                  if (activeStep < 8) {
                                    if (activeStep == 0) {
                                      if (nameController.text.isEmpty) {
                                        ...
                                        return;
                                      } else if (selectedSubCategoryItem ==
                                          null) {
                                        utils.snackBar(context,
                                        ...
                                        return;
                                      } else if (wholeSalePriceController
                                          .text.isEmpty) {
                                        utils.snackBar(context,
                                            message:
                                      ...
                                      addProductModel.type =
                                          selectedCategoryItem!.code.toString();
                                      addProductModel.style =
                                          selectedSubCategoryItem!.code
                                              .toString();
                                      addProductModel.typeName =
                                          selectedCategoryItem!.name.toString();
                                      addProductModel.styleName =
                                          selectedSubCategoryItem!.name
                                              .toString();
                                      addProductModel.salesRate = double.parse(
                                          priceController.text.toString());
                                      addProductModel.wholeSale = double.parse(
                                          wholeSalePriceController.text
                                              .toString());
                                      addProductModel.gSTTax = double.parse(
                                      ...
                                      addProductModel.disCont =
                                          discPriceController.text.isEmpty
                                              ? false
                                              : true;
                                      addProductModel.discountType =
                                          selectedDiscount == 0 ? "%" : "@";
                                      addProductModel.discountVal =
                                          double.parse(discPriceController.text
                                              .toString());
                                      addProductModel.totalStock = int.parse(
                                          stockController.text.toString());
                                      activeStep++;
                                      FocusScope.of(context).unfocus();
                                    } else if (activeStep == 1) {
                                      if (sDescriptionController.text.isEmpty) {
                                        addProductModel.shortDescription =
                                            "N/A";
                                      ...
                                      addProductModel.mUnit =
                                          unitController.text.isNotEmpty
                                              ? unitController.text.toString()
                                              : "N/A";
                                      addProductModel.brandCode =
                                          selectedBrand != null
                                              ? selectedBrand!.code.toString()
                                              : null;
                                      addProductModel.brandName =
                                          selectedBrand != null
                                      ...
                                      if (pDeliveryPriceController
                                          .text.isNotEmpty) {
                                        addProductModel.deliveryPrice =
                                            double.parse(
                                                pDeliveryPriceController.text
                                                    .toString());
                                      }

                                      if (pDeliveryApplyController
                                          .text.isNotEmpty) {
                                        addProductModel.deliveryApplyItem =
                                            int.parse(pDeliveryApplyController
                                                .text
                                                .toString());
                                      }

                                      if (pDeliveryFreeController
                                          .text.isNotEmpty) {
                                        addProductModel.freeDeliveryItems =
                                            int.parse(pDeliveryFreeController
                                                .text
                                                .toString());
                                      }

                                      if (pMinDeliveryController
                                          .text.isNotEmpty) {
                                        addProductModel.minDeliveryTime =
                                            int.parse(pMinDeliveryController
                                                .text
                                                .toString());
                                      }

                                      if (pMaxDeliveryController
                                          .text.isNotEmpty) {
                                        addProductModel.maxDeliveryTime =
                                            int.parse(pMaxDeliveryController
                                                .text
                                                .toString());
                                      }
                                      ...
                                      for (var a in addons) {
                                        addProductModel.addons.add(a.key);
                                      }
                                      activeStep++;
                                      FocusScope.of(context).unfocus();
                                ...
                                child: Container(
                                    ...
                                    decoration: BoxDecoration(
                                        ...
                                        color: checkAdminController
                                            .system.mainColor),
                                    child: Text(
                                      activeStep < 8 ? "Next" : "Done",
                                      style:
                                          utils.boldSmallLabelStyle(whiteColor),
                                    ))),
                          ],
                        ),
                      )
  ...
  Widget form(String hints, TextEditingController controller,
      {onChange, isMultiline, isNumber, enable}) {
    return Container(
      padding: EdgeInsets.symmetric(horizontal: 12, vertical: 16),
      decoration: BoxDecoration(
          borderRadius: BorderRadius.circular(8),
                                                          ...
                                                          child: Center(
                                                            child: Container(
                                                              ...
                                                              decoration: BoxDecoration(
                                                                  shape: BoxShape
                                                                      .circle,
                                                                  color: selectedCategoryItem !=
                                                                              null &&
                                                                          selectedCategoryItem!.code ==
                                                                              categoryController
                                                                                  .categories[
                                                                                      i]
                                                                                  .code
                                                              ...
                                                              child: Center(
                                                                child:
                                                                  ...
                                                                  decoration: BoxDecoration(
                                                                      shape: BoxShape
                                                                          .circle,
                                                                      color: selectedSubCategoryItem != null && selectedSubCategoryItem!.code == subCategoryController.subCategories[i].code
                                                                          ? checkAdminController
                                                                              .system
                                                                              .mainColor
                                                                          : Colors
                                                                  ...
                                                                  child: Center(
                                                                    child:
                                                                      ...
                                                                      decoration: BoxDecoration(
                                                                          shape: BoxShape
                                                                              .circle,
                                                                          color: selectedPColor != null && selectedPColor!.colorId == pColorsDefault[i].colorId.toString()
                                                                              ? checkAdminController.system.mainColor
                                                                              : Colors.transparent),
                                                                    ),
                                                                  ),
                                                      ...
                                                      if (itemAddonController
                                                        ...
                                                        utils.selectionItem(
                                                            itemAddonController
                                                                .addons[i]
                                                                .adonDescription,
                                                            "(${itemAddonController.addons[i].adonPrice})",
                                                            false, () {
                                                          selectedAddon =
                                                              itemAddonController
                                                                  .addons[i];
  ...
  showAddAddonDialog(BuildContext context) {
    showCupertinoModalBottomSheet(
      enableDrag: true,
      isDismissible: false,
      expand: true,
  ...
  void addProduct() async {
    ...
    if (Get.arguments == null) {
      var code = productController.lastItem == null
          ? 1
          : int.parse(productController.lastItem!.code) + 1;
      var child = code < 10
          ? "0000000$code"
          : code < 100
              ? "000000$code"
      ...
      await reference
          .child(itemRef)
          .child("$child")
          .set(addProductModel.toJson());
      productController.lastItem = addProductModel;

      for (var i = 0; i < addProductModel.sizes.length; i++) {
        addProductModel.name =
            productName + "-" + addProductModel.sizes[i].size;
        addProductModel.salesRate =
            double.parse(addProductModel.sizes[i].price);
        addProductModel.wholeSale =
            double.parse(addProductModel.sizes[i].wPrice);
      ...
      var parentId = addProductModel.parentId == null
          ? addProductModel.code
          : addProductModel.parentId;
      ...
      await reference
          .child(itemRef)
          .child("${addProductModel.code}")
          .update(addProductModel.toJson());
